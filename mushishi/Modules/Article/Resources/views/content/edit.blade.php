                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="category_id" class="form-control-xs form-control">
                                    @foreach($categories as $category)
                                        <option value="{{$category['id']}}" {{$category['id'] == $content['category_id']?'selected':''}}>{!! $category['_name'] !!}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <div class="form-group row">
                            <label for="content" class="col-12"  style="padding-top:initial;">内容</label>
                            <div class="col-12 col-md-9">
