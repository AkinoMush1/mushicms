            ...
            <div class="splash-container">
                <div class="card card-border-color card-border-color-primary">
                    <div class="card-header"><img src="{{asset('theme/beagle/img/logo-xx.png')}}" alt="logo" width="120" height="27" class="logo-img">
                        <span class="splash-description">后台登录系统</span></div>
                    <div class="card-body">
                        <form action="{{route('admin.login')}}" method="post">
                            ...
                            <div class="login-form">
                                <div class="form-group">
                                    <input id="name" type="name" name="name" placeholder="用户名" value="admin" autocomplete="off" class="form-control">
                                </div>
                                <div class="form-group">
                                    <input id="password" type="password" name="password" placeholder="登录密码" value="123456789" class="form-control">
                                </div>
